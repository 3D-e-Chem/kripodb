# -*- coding: utf-8 -*-
#
# KripoDB documentation build configuration file, created by
...
project = u'KripoDB'
copyright = u'2016, Nederlands eScience Center'
...
version = kripodb.version.__version__
# The full version, including alpha/beta/rc tags.
release = kripodb.version.__version__
...
latex_documents = [
    (master_doc, 'KripoDB.tex', u'KripoDB Documentation',
...
man_pages = [
    (master_doc, 'kripodb', u'KripoDB Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KripoDB', u'KripoDB Documentation',
     author, 'KripoDB', 'One line description of project.',
     'Miscellaneous'),
]
